...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://interop.esante.gouv.fr/ig/document/ips/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    {
      "id" : "Ressources CDA IPS",
      "name" : "Eléments CDA d'un document IPS"
    },
    {
    ...
    },
    {
      ...
      "name" : "Bundle-IPS-FR",
      "exampleCanonical" : "https://interop.esante.gouv.fr/ig/document/ips/StructureDefinition/fr-bundle-document-ips|0.1.0"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-fr-cda-clinical-document-ips.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/fr-cda-clinical-document-ips"
      },
      "name" : "CDA - clinicalDocument IPS",
    ...
    },
    {
      ...
      "description" : "Volet International Patient Summary - France (IPS-FR)",
      ...
      },
      {
        ...
        "page" : [{
          ...
          "page" : [{
            "extension" : [{
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "structureCDA.html"
            }],
            "nameUrl" : "structureCDA.html",
            "title" : "Structure du document IPS en CDA",
            "generation" : "markdown"
          },
          {
            "extension" : [{
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "exemplesCDA.html"
            }],
            "nameUrl" : "exemplesCDA.html",
            "title" : "Exemples CDA",
            "generation" : "markdown"
          },
          {
            "extension" : [{
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "exempleIHE-XDM.html"
            }],
            "nameUrl" : "exempleIHE-XDM.html",
            "title" : "Exemples IHE XDM",
            "generation" : "markdown"
          }]
        },
        {
          ...
          "page" : [{
            "extension" : [{
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "structureFHIR.html"
            }],
            "nameUrl" : "structureFHIR.html",
            "title" : "Structure du document IPS en FHIR",
            "generation" : "markdown"
          },
          {
            "extension" : [{
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "exemplesFHIR.html"
            }],
            "nameUrl" : "exemplesFHIR.html",
            "title" : "Exemples FHIR",
            "generation" : "markdown"
          }]
        },
