...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.document.fr.ips|current/StructureDefinition/StructureDefinition-fr-composition-document-ips.json)
...
Other representations of profile: [CSV](../StructureDefinition-fr-composition-document-ips.csv), [Excel](../StructureDefinition-fr-composition-document-ips.xlsx), [Schematron](../StructureDefinition-fr-composition-document-ips.sch) 
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "https://interop.esante.gouv.fr/ig/document/ips/StructureDefinition/fr-composition-document-ips|0.1.0"
      },
      {
