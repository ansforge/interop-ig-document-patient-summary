# Cas d'usage - ANS IG Document IPS v0.1.0
...
### 2. La création de la synthèse médicale d'un Dossier de liaison d'urgence (DLU)
...
### 3. L'échange de la synthèse médicale avec d'autres professionnels de santé
...
### 4. La mise en partage de la synthèse médicale dans le DMP (Mon espace santé)
