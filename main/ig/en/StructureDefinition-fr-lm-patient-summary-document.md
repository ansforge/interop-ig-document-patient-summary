...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.document.fr.ips|current/StructureDefinition/StructureDefinition-fr-lm-patient-summary-document.json)
