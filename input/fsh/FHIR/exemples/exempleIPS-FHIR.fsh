...
* entry[0].fullUrl = "urn:uuid:09275181-4d85-43b8-89b0-6dd68182bc52"
* entry[=].resource = Composition-IPS-FR
* entry[+].fullUrl = "urn:uuid:00f54e2e-22f2-4162-87b4-4826d855feac"
* entry[=].resource = patientExemple
* entry[+].fullUrl = "urn:uuid:a11d31c5-77ff-4642-91f7-66c4d10d18c9"
* entry[=].resource = practitioner-role-exemple-1
* entry[+].fullUrl = "urn:uuid:b5941194-08be-4893-a629-652f97587b39"
* entry[=].resource = practitioner-exemple-1
* entry[+].fullUrl = "urn:uuid:579f1274-8265-4bb1-91ba-d093a11be4f5"
* entry[=].resource = organizationExemple
* entry[+].fullUrl = "urn:uuid:51807e91-cb17-4ca1-bc58-1efa85cf9d72"
* entry[=].resource = encounterExemple
* entry[+].fullUrl = "urn:uuid:648170b7-1538-44a7-8820-df04dcc32fad"
* entry[=].resource = locationExemple
* entry[+].fullUrl = "urn:uuid:257427f5-dffa-4a97-9475-4ebb988589af"
* entry[=].resource = Condition-Exemple-1
* entry[+].fullUrl = "urn:uuid:4d6a4b74-b2a7-4ec1-8db1-8925f435a916"
* entry[=].resource = Condition-Exemple-2
* entry[+].fullUrl = "urn:uuid:af0e13e5-d0a2-4dbc-b892-7328eca72ff4"
...
* entry[=].resource = Condition-Exemple-6
* entry[+].fullUrl = "urn:uuid:18492799-4e37-47a7-b79b-18a4d0597963"
* entry[=].resource = Condition-Exemple-7
* entry[+].fullUrl = "urn:uuid:4e00844f-241b-47c0-85a4-9d612c46b3ad"
* entry[=].resource = Procedure-Exemple-1
* entry[+].fullUrl = "urn:uuid:5b0fcb3b-91fb-4870-bd97-8faa2794ea01"
* entry[=].resource = practitioner-role-exemple-2
* entry[+].fullUrl = "urn:uuid:da9eb2be-5993-4e39-827b-728fe3943a93"
* entry[=].resource = organizationExemple2
* entry[+].fullUrl = "urn:uuid:9e55af45-e661-472f-b713-4aaa2cfd1a77"
* entry[=].resource = practitioner-exemple-2
* entry[+].fullUrl = "urn:uuid:be247a4c-f8fe-4224-b51c-8c35d7124a2d"
* entry[=].resource = Condition-Exemple-8
* entry[+].fullUrl = "urn:uuid:3c6ec5d8-182d-4dfc-871b-59c9eb91aa51"
...
* entry[=].resource = MedicationAdministration-Exemple-1
* entry[+].fullUrl = "urn:uuid:f995f9bb-4043-45db-8b12-50dc7e9acc5a"
...
* entry[=].resource = Device-Exemple-1
* entry[+].fullUrl = "urn:uuid:41465f6b-d169-40b9-8d84-96064b4c3d28"
* entry[=].resource = DeviceUseStatement-Exemple-2
* entry[+].fullUrl = "urn:uuid:f38b1772-ca78-4578-be14-f7a493b2cbb9"
* entry[=].resource = Device-Exemple-2
* entry[+].fullUrl = "urn:uuid:960ebfbc-4b56-40b9-9990-cae5944d6e9b"
* entry[=].resource = Observation-Exemple1-Groupe-de-questionnaires-d-evaluation
* entry[+].fullUrl = "urn:uuid:e102b4b3-91b6-4b89-9065-560bc68c024c"
...
* entry[=].resource = Observation-Exemple-4-Signe-vital-observe
* entry[+].fullUrl = "urn:uuid:48129cb5-0a81-4a17-aebd-8c6584b20cd4"
* entry[=].resource = Observation-Exemple-5-Habitus-Mode-De-Vie
* entry[+].fullUrl = "urn:uuid:3618f351-cea4-4834-8cf9-10151b74436b"
* entry[=].resource = Observation-Exemple-6-Habitus-Mode-De-Vie
* entry[+].fullUrl = "urn:uuid:4f0f3856-74a9-4a57-b173-e8342735d6c9"
* entry[=].resource = Observation-Exemple-7-Habitus-Mode-De-Vie
* entry[+].fullUrl = "urn:uuid:3799b968-d637-4a16-ad7b-5f79987dcdb1"
* entry[=].resource = Observation-Exemple-8-Habitus-Mode-De-Vie
* entry[+].fullUrl = "urn:uuid:541404fa-fc9c-4552-8d36-10adcc37f34e"
* entry[=].resource = FamilyMemberHistory-Exemple-1
* entry[+].fullUrl = "urn:uuid:7f0d585b-9a48-4605-baab-30e93603a563"
* entry[=].resource = Immunizations-Exemple-1
* entry[+].fullUrl = "urn:uuid:3a7417c1-d483-4f56-833d-43bf8e438874"
* entry[=].resource = Immunizations-Exemple-2
* entry[+].fullUrl = "urn:uuid:f3062170-ef7b-45a7-802f-47e461a7d05d"
* entry[=].resource = practitioner-role-exemple-3
* entry[+].fullUrl = "urn:uuid:4dbc2eff-6a94-4c7b-b49f-0f7a9790bef6"
* entry[=].resource = organization-Exemple-3
* entry[+].fullUrl = "urn:uuid:ab96b0ff-374a-45c7-82e4-aaa8888a2fec"
* entry[=].resource = practitioner-exemple-3
* entry[+].fullUrl = "urn:uuid:80c62f71-7c99-458d-884d-725bc410a14d"
* entry[=].resource = Condition-Exemple-10
* entry[+].fullUrl = "urn:uuid:bea6c387-6dca-4f55-93b7-7079e1c88dfb"
* entry[=].resource = Observation-Exemple-8-sur-la-grossesse
* entry[+].fullUrl = "urn:uuid:bdc0e3ae-128b-46de-b1a7-1c564cca6a61"
* entry[=].resource = Observation-Exemple-9-sur-la-grossesse
* entry[+].fullUrl = "urn:uuid:e4299828-2563-4265-9297-c27a8240b6ba"
* entry[=].resource = Observation-Exemple-10-sur-la-grossesse
...
* device = Reference(urn:uuid:7bb3e1f4-15bd-4c06-a587-3445c0f5a530) "STIMULATEUR CARDIAQUE IMPLANTABLE TRIPLE CHAMBRE"
...
* effectiveDateTime = "2018-01-14T15:06:00+00:00"
* valueCodeableConcept = $LNC#LA9622-7 "Capable d’une activité identique à celle précédant la maladie sans aucune restriction"
* note.text = "Texte libre"
